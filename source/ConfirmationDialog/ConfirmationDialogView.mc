...
class ConfirmationDialogView extends WatchUi.View {
    ...
    public function initialize() {
        System.println("ConfirmationDialogView: initialize()");
        View.initialize();
    ...
    public function onLayout(dc as Dc) as Void {
        System.println("ConfirmationDialogView: onLayout()");
    ...
    public function onUpdate(dc as Dc) as Void {
        System.println("ConfirmationDialogView: onUpdate()");
    ...
    public function setResultString(resultString as String) as Void {
        System.println("ConfirmationDialogView: setResultString() resultString = " + resultString);
